...
else
{
    ...
    imageelement.setAttribute("style","border-radius:50%");
    imageelement.setAttribute("style","width:68px");
    newelement.textContent="sorry wrong answer The correct answer is VERDE";
    divelement.appendChild(newelement);
    divelement.appendChild(imageelement);   
    divelement.setAttribute("style","background:red;width:200px;height:34px;border-radius:10px;margin:0 auto;text-align:center");
    bodyelement.insertBefore(divelement,insertelement);
}
}